<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:drivers:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:drivers:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:drivers:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="driversList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="司机历史违规记录" align="center" prop="violationRecord" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="司机历史违规记录" prop="violationRecord">
          <el-input v-model="form.violationRecord" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listDrivers, getDrivers, delDrivers, addDrivers, updateDrivers } from "@/api/system/drivers";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getDrivers(driverId).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/drivers/export', {
        ...this.queryParams
