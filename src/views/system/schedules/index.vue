<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否冲突" prop="conflictDetected">
        <el-input
          v-model="queryParams.conflictDetected"
          placeholder="请输入是否冲突"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="schedulesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="是否冲突" align="center" prop="conflictDetected" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否冲突" prop="conflictDetected">
          <el-input v-model="form.conflictDetected" placeholder="请输入是否冲突" />
        </el-form-item>
      </el-form>
